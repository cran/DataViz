...
RcppExport SEXP _DataViz_rcpp_throwchart(SEXP beforeSEXP, SEXP afterSEXP, SEXP colSEXP, SEXP idSEXP, SEXP lwdSEXP, SEXP xlimSEXP, SEXP offSetSEXP, SEXP pathSEXP) {
BEGIN_RCPP
    ...
    rcpp_throwchart(before, after, col, id, lwd, xlim, offSet, path);
    return R_NilValue;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_DataViz_rcpp_throwchart", (DL_FUNC) &_DataViz_rcpp_throwchart, 8},
    {NULL, NULL, 0}
};
